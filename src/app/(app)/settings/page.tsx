...
export default function SettingsPage() {
  ...
  // One-time fetch — avoids resetting the form on every Firestore write
  useEffect(() => {
    if (!user) return;
  ...
  async function handleSave() {
    ...
    try {
      ...
      // (covers users who signed in with Google and skipped onboarding)
      await setDoc(
      ...
      <div className="flex items-start justify-between mb-8 gap-4">
        <div>
          ...
          <p className="text-muted-foreground">
            Manage your income goals and specialty.
          </p>
        </div>
